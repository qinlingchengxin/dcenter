            ...
            <table>
                ...
                <c:forEach items="${busCustomEntities}" var="busCustomEntity" varStatus="vs">
                    <tr>
                        ...
                        <td>${busCustomEntity.inChinese}</td>
                        <td>${busCustomEntity.description}</td>
                        <td>
                        ...
                        <td style="text-align: left;">
                            <span><a href="${baseUrl}/front/busCustomField/list.do?tableName=${busCustomEntity.tableName}" target="rightFrame"><img src="${baseUrl}/img/bianji.png">查看字段</a></span>
                            <span><a href="${baseUrl}/front/busCustomEntity/dataTemplate.do?tableName=${busCustomEntity.tableName}" target="rightFrame"><img src="${baseUrl}/img/bianji.png">数据模板</a></span>
                        </td>
                    </tr>
                </c:forEach>
            </table>
