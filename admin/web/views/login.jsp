...
<head>
    ...
    <script type="text/javascript">
        ...
        function chgFormUrl(node) {
            var form = document.getElementById("frm");
            if (node.checked) {
                form.setAttribute("action", "${baseUrl}/web/admin/login.do");
            } else {
                form.setAttribute("action", "${baseUrl}/front/login.do");
            }
        }
    </script>
</head>
        ...
        <form id="frm" action="${baseUrl}/web/admin/login.do" method="post">
            <div class="loginBox fr">
                ...
                <div class="clearfloat">
                    <span style="margin-right: 5px;">管理员</span> <input onchange="chgFormUrl(this);" type="checkbox" name="manager" checked="checked">
                </div>
                <div class="entry">
