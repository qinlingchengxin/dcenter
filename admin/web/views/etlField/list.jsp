    ...
    <div class="content_right fr">
        <div class="first clearfloat">
            ...
            <div class="fr operation">
                <span><a href="${baseUrl}/web/etl/fieldList.do?entityId=${entityId}" target="rightFrame"> <img src="${baseUrl}/img/zengjia.png">刷新</a></span>
                ...
                <c:forEach items="${etlFields}" var="etlField" varStatus="vs">
                    <tr id="tr_${etlField.id}">
                        ...
                        <td style="text-align: left;">
                            <span><a href="javascript:fieldDel('${etlField.id}');"><img src="${baseUrl}/img/bianji.png">删除</a></span>
                        </td>
                    </tr>
                </c:forEach>
            </table>
