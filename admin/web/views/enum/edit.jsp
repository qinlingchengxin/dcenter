...
<head>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            $.ajax({
                url: "${baseUrl}/web/sys/enumSave.do",
                type: "POST",
                data: baseObj,
                dataType: "json",
        ...
        function add() {
            ...
            var baseObj = form.serializeObject();
            $.ajax({
                url: "${baseUrl}/web/sys/enumAdd.do",
                type: "POST",
                data: baseObj,
                dataType: "json",
                success: function (result) {
...
<div class="content clearfloat">
    <div class="content_right fr">
        <div class="first">
            <a href="javascript:history.go(-1);">返回</a><span>></span><a href="javascript:void(0)">系统枚举</a>
        </div>
        <div class="second">
            <form id="form">
                <input type="hidden" id="id" name="id" value="${busEnum.id}"/>

                <div>
                    <span class="title">代码</span>
                    <input id="doc-ipt-code-1" type="text" name="code" value="${busEnum.code}" readonly/>
                </div>

                <div>
                    <span class="title">名称</span>
                    <input id="doc-ipt-enumName-1" type="text" name="enumName" value="${busEnum.enumName}"/>
                </div>

                <div>
                    <c:if test='${busEnum.id  == null}'>
