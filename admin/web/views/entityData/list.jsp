...
<head>
    ...
    <script type="text/javascript">
        function searchData() {
            ...
            window.location = "${baseUrl}/web/common/queryData.do?tableName=" + tableName + "&platformCode=" + platformCode;
        }
    </script>
</head>
<body>
        ...
        <div class="third">
                ...
                <c:forEach items="${entityDataList}" var="entityData" varStatus="vs">
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <span><a href="${baseUrl}/web/common/viewData.do?tableName=${tableName}&sysId=${entityData.SYS__ID}" target="rightFrame"><img src="${baseUrl}/img/chakan.png">查看</a></span>
                        </td>
                    </tr>
                </c:forEach>
            </table>
            <div class="fenye">
                <ul class="fy_ul">
                    ...
                    <c:if test="${currPage > 1}">
                        <li><a href="${baseUrl}/web/common/queryData.do?tableName=${tableName}$page=${currPage - 1}">上一页</a></li>
                    </c:if>
                    ...
                    <c:if test="${currPage < totalPage}">
                        <li><a href="${baseUrl}/web/common/queryData.do?tableName=${tableName}$page=${currPage + 1}">下一页</a></li>
                    </c:if>
                </ul>
            </div>
        </div>
