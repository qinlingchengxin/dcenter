...
<head>
    ...
    <script type="text/javascript">
        function projectDel(id) {
            $.ajax({
                url: "${baseUrl}/web/etl/projectDel.do?id=" + id,
                type: "GET",
                dataType: "json",
    ...
    <div class="content_right fr">
        <div class="first clearfloat">
            ...
            <div class="fr operation">
                <span><a href="${baseUrl}/web/etl/projectList.do" target="rightFrame"> <img src="${baseUrl}/img/zengjia.png">刷新</a></span>
                ...
                <c:forEach items="${etlProjects}" var="etlProject" varStatus="vs">
                    <tr id="tr_${etlProject.id}">
                        ...
                        <td style="text-align: left;">
                            ...
                            <span><a href="javascript:projectDel('${etlProject.id}');"><img src="${baseUrl}/img/bianji.png">删除</a></span>
                            <span><a href="${baseUrl}/web/etl/entityList.do?prjId=${etlProject.id}" target="rightFrame"><img src="${baseUrl}/img/bianji.png">映射表</a></span>
                        </td>
                    </tr>
                </c:forEach>
            </table>
