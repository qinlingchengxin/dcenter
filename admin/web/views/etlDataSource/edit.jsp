        ...
        <div class="second">
            <form id="form">
                ...
                <div>
                    ...
                    <select id="doc-ipt-dbType-1" name="dbType">
                        ...
                        <option value="MSSQL" <c:if test="${dataSource.dbType == 'MSSQL'}">selected="selected"</c:if>>MS SQL</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input id="doc-ipt-dbPort-1" type="text" name="dbPort" value="${dataSource.dbPort}"/>
                </div>
