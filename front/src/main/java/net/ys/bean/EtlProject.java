...
public class EtlProject implements Serializable {
    ...
    public String getCenterDbType() {
        return centerDbType;
    }

    public void setCenterDbType(String centerDbType) {
    ...
    public String getBusDbType() {
        return busDbType;
    }

    public void setBusDbType(String busDbType) {
